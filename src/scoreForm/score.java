...
public class score extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel17.add(deletePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 210, -1, 39));
        ...
        jPanel17.add(printPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 270, -1, 39));
    ...
    private void editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMouseClicked
        ...
        if(rowIndex < 0){
            ...
            try{
                dbConnector dbc = new dbConnector();
                TableModel tbl = scoreTable.getModel();
