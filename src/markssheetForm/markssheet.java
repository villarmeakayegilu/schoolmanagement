...
public class markssheet extends javax.swing.JFrame {
    ...
    Color hovercolor = new Color(102,255,255);
        ...
        try {
            ...
            markssheetTable.setModel(DbUtils.resultSetToTableModel(rs));
            rs.close();
    ...
    private void initComponents() {
        ...
        markssheetTable = new javax.swing.JTable();
        ...
        markssheetTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane4.setViewportView(markssheetTable);
        ...
        jLabel8.setText("Mark Sheet Form");
        ...
        jPanel17.add(addPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 90, -1, -1));
        ...
        jPanel17.add(editPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, -1, 39));
    ...
    private void editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMouseClicked
        int rowIndex = markssheetTable.getSelectedRow();
        ...
        if(rowIndex < 0){
            ...
            try{
                dbConnector dbc = new dbConnector();
                TableModel tbl = markssheetTable.getModel();
    ...
    private javax.swing.JTable markssheetTable;
